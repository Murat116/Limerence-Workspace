...
Источник истины для правил: `Спецификация/Логика геймплея/`. Код — `src/Feature/Quest/`, `src/App/store/quest/`, `src/Service/Quest/`.
...
| Спецификации сущностей | `Спецификация/Логика геймплея/Сущности/` |
| Общий flow | `Спецификация/Логика геймплея/Логика геймплея.md` |
