...
@see [IOS_IMPL_PLAN.md](../../docs/monetization/IOS_IMPL_PLAN.md) — технический план store-IAP  
@see [Paywall-UI-UX.md](./Paywall-UI-UX.md) — UX, иерархия офферов, конверсия  
@see [WebBilling-RU.md](./WebBilling-RU.md) — RU web checkout (**после запуска**, не сейчас)  
@see [Аналитика события.md](../Аналитика%20события.md)  
@see [Глава.md](../Логика%20геймлея/Сущности/Глава.md)
...
| **После запуска** | PW-09 (skip tokens), [WebBilling-RU.md](./WebBilling-RU.md) (PW-10)                                     |
...
1. **Store-only при запуске** — RU web → [WebBilling-RU.md](./WebBilling-RU.md) позже.
...
8. **Иерархия офферов на paywall** — см. [Paywall-UI-UX.md](./Paywall-UI-UX.md): блок подписки (год / месяц / trial) + «навсегда» + контекстный Chapter Pass.
...
² **Гибрид** — структура офферов в [Paywall-UI-UX.md](./Paywall-UI-UX.md) §«Иерархия офферов».  
...
- **PW-10** — [WebBilling-RU.md](./WebBilling-RU.md), после запуска
...
Дополнить [Аналитика события.md](../Аналитика%20события.md).
...
| Q-17–Q-21 | См. [WebBilling-RU.md](./WebBilling-RU.md)                                           |
...
| Документ                                          | Назначение                           |
| ------------------------------------------------- | ------------------------------------ |
| [WebBilling-RU.md](./WebBilling-RU.md)            | RU web checkout (будущее)            |
| [Paywall-UI-UX.md](./Paywall-UI-UX.md)            | UX, офферы, ротация, success screens |
| `Спецификация/Монетизация/Entitlements.md`        | Resolver, формулы (создать)          |
| [Глава.md](../Логика%20геймлея/Сущности/Глава.md) | UI оглавления                        |
...
- [ ] [WebBilling-RU.md](./WebBilling-RU.md)
- [ ] PW-09