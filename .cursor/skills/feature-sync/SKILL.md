---
name: feature-sync
description: После approve записывает утверждённый spec в docs/, Supabase migrations, Notion и rules; лог в 04-sync-log.md. Use when user invokes /feature-sync after feature-approve.
...
- Web constructor: `web/` in Limerence-Workspace (same workspace as mobile)
...
|----------|----------|------------|
| `docs/specs/` | file edit | `@see` в коде позже в implement |
| `docs/monetization/` RN | file edit | если в scope |
| `web constructor (web/)/docs/` | file edit | абсолютный путь |
