...
description: Сверяет требования фичи с RN-кодом, web constructor (web/), Supabase, Figma и Notion; пишет 02-discrepancies.md plain-language. Use when user invokes /feature-reconcile or after feature-brief.
...
```
Readonly. Path: Limerence-Workspace/mobile
From brief: [paste acceptance criteria + feature name]
Read: docs/specs/, src/Feature/, src/Service/, src/App/store/, .cursor/rules/
...
```
Readonly. Path: Limerence-Workspace/web
