...
Full Repository Path: /Users/anmin/iosProject/limerenceProject/LemereceRN
...
- [ ] `@see Спецификация/` на новой бизнес-логике
- [ ] UI copy vs Figma/spec (если применимо)
- [ ] Analytics events vs `Спецификация/Аналитика события.md`
